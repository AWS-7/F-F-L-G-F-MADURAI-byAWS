...
const DietPlanResult = memo(function DietPlanResult() {
  ...
  const dietPlan = useMemo(() => {
    ...
    const meals = mealDatabase[formData.goal][formData.preference];
    const baseCalories = calorieTargets[formData.goal][formData.preference];
    const budgetMultiplier = budgetMultipliers[formData.budget];
