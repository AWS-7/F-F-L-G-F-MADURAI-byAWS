-- FemmeFlex Database Schema
-- SQLite database for enquiry forms and BMI tracking

-- Enquiries table - stores contact form submissions
...
-- BMI Records table - stores BMI calculations
CREATE TABLE IF NOT EXISTS bmi_records (
    ...
    category TEXT NOT NULL, -- Underweight, Normal Weight, Overweight, Obese
    notes TEXT,
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP
);
